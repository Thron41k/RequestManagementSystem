...
namespace WpfClient.ViewModels
{
    internal class DriverViewModel : INotifyPropertyChanged
    {
        ...
        public DriverViewModel(GrpcRequestService requestService)
        {
            ...
            async void Execute5() => await SelectAndClose();
        }
        ...
        {
            if (!string.IsNullOrWhiteSpace(NewDriverFullName) && !string.IsNullOrWhiteSpace(NewDriverShortName) && !string.IsNullOrWhiteSpace(NewDriverPosition))
            {
