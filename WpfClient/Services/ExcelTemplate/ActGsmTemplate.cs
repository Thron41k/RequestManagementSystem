...
public class ActGsmTemplate : ExcelTemplateWriterBase<ActPartsModel>
{
    public override ExcelTemplateType TemplateType => ExcelTemplateType.ActGsm;
    public override byte[] FillTemplate(ActPartsModel data)
    {
        var startDataRow = 21;
        ExcelPackage.License.SetNonCommercialPersonal("Thron41k");
        using var stream = GetTemplateStream("ActGsmTemplate.xlsx");
        ...
        templateSheet.Cells[5, 1, 5, 3].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
