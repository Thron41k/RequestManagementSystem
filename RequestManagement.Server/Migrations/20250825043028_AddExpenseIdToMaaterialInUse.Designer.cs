...
namespace RequestManagement.Server.Migrations
{
    ...
    [Migration("20250825043028_AddExpenseIdToMaaterialInUse")]
    partial class AddExpenseIdToMaaterialInUse
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RequestManagement.Common.Models.MaterialsInUse", b =>
                {
                    ...
                    b.HasOne("RequestManagement.Common.Models.Driver", "MolForMove")
                        .WithMany()
                        .HasForeignKey("MolForMoveId")
                        .OnDelete(DeleteBehavior.Restrict);
